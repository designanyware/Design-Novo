...
var sF$=(function(){
  ...
  function fnLoginUserName(NameUser,PicUser){
    ...
    if(NameUser==""){
      jQuery('.loginInfo').html("<span class='col-small-12'>Olá, <b>visitante</b></span> <br> <span class='col-small-12 HeaderSolcialLoginDoit'>Faça seu <a href='/cadastro.asp?idloja="+FC$.IDLoja+"&pp=3&passo=1&sit=1'><b>Login</b></a></span>");
